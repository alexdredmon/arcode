...
class TestUserMenu(unittest.TestCase):
    ...
    def test_handle_user_menu(self, mock_write_files, mock_print_tokens, mock_calculate_token_count, mock_prompt):
...
"""
    ...
    @patch('lib.user_menu.print_tokens')
    @patch('lib.user_menu.write_files')
    def test_handle_user_menu_autowrite(self, mock_write_files, mock_print_tokens, mock_calculate_token_count, mock_prompt):
